...
public class Util {
    ...
    static final List<String> supported_doc_ext = Arrays.asList("pdf", "djv", "djvu", "tex", "latex", "rtf", "wmf", "md", "mkd", "mkdn", "mdwn", "mdown", "markdown", "odt", "ott", "odp", "otp", "ods", "ots", "fodt", "fods", "fodp", "ipynb");
